...
def get_flight_price(route):
    prices = {
        "Mumbai-Delhi": 6500,
        "Delhi-Bangalore": 7200,
        "Mumbai-Goa": 4000
    }

    return prices.get(route, "Route not found")
...
1. get_flight_price(route)
2. calculator(expression)

IMPORTANT:
Call tools exactly like these examples:

Action: get_flight_price("Mumbai-Goa")
Action: calculator("50000 - 4000")
...
Tell me:
1. Flight price
2. Remaining money after booking.
"""
run_agent(prompt)